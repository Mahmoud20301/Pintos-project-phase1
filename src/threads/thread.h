...
//      added
   int nice;        
   Fixed_P recent_cpu; 
   struct list_elem elemSleep; 
   int64_t ticks_remain_toWakeup; 
   int64_t wake_up_tick;    //local tick for each thread
///////////////////////////////////////////////////////////////////// 
...
bool compare_priority_sleep(const struct list_elem *a, const struct list_elem *b, void *aux UNUSED);
